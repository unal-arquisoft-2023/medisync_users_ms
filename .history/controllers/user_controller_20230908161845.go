...
// get all info of a patient, including user info and patient info, using createPatientRequest struct
func GetPatient(c echo.Context) error {
	...
	patientResponse.Affiliation = models.PatientAffiliation(patient.Affiliation)
